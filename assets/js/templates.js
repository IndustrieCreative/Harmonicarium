...
HUM.tmpl = {
    ...
    dpIcons(humID) {
        ...
        let icons = {
            ...
            htOctaveUp: {
                viewBox: "0 2 30 20",
                elements: [
                    { tag: 'text', attrs: { x: '1', y: '17', 'font-family': 'Arial, Helvetica, sans-serif', 'font-size': '15', 'font-weight': '700', fill: '#c5c5c5' }, text: 'HT' },
                    { tag: 'text', attrs: { x: '20', y: '17', 'font-family': 'Arial, Helvetica, sans-serif', 'font-size': '13', 'font-weight': '700', fill: '#c5c5c5' }, text: '+' },
                ]
            },
            htOctaveDown: {
                viewBox: "0 2 30 20",
                ...
                elements: [
                    {
                        tag: 'path',
                        attrs: {
                            d: "M14 2H6C4.9 2 4 2.9 4 4v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6z M14 2v6h6",
                            fill: 'none',
                            stroke: '#c5c5c5',
                            'stroke-width': '1.5',
                    ...
                    },
                    {
                        ...
                        attrs: {
                            d: "M21.775 7.517H24v8.966h-2.225zm-8.562 0h6.506c.66 0 1.045.57 1.045 1.247v6.607c0 .84-.35 1.112-1.112 1.112h-6.439v-5.696h2.225v3.505h3.135V9.54h-5.36zm-3.235 0h2.19v8.966h-2.19zM0 7.517h7.854c.66 0 1.045.57 1.045 1.247v7.72H6.708v-6.71H5.427v6.708H3.438V9.775H2.191v6.708H0z",
                            transform: "translate(5, 8.5) scale(0.583)"
                        }
                    }
                ]
            },
                        ...
                        <div class="col-lg-8" id="HTMLf_synth_beatSamples${dhcID}" style="display:none;">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul id="HTMLf_synth_sampleList${dhcID}" class="list-unstyled mb-2"></ul>
                                    <button type="button" id="HTMLi_synth_addSampleBtn${dhcID}" class="btn btn-sm btn-outline-secondary">+ Add sample</button>
                                    <input type="file" id="HTMLi_synth_addSampleFile${dhcID}" accept="audio/*" style="display:none;">
    ...
    /**
     * Creates the MIDI Player side-panel UI (file picker, transport controls,
     * destination dropdown, seek slider, speed and loop controls).
     *
     * @memberof HUM.tmpl
     * @param {string} dhcID - The DHC instance ID.
     * @param {number} humID - The HUM instance ID (for icon refs).
     *
     * @returns {HTMLDivElement} The MIDI Player controls container.
     */
    midiPlayerBox(dhcID, humID) {
        let template = document.createElement('div');
        template.innerHTML = `
            <div class="midiPlayer" id="HTML_midiPlayer${dhcID}">
                ...
                <div class="row g-2 mb-3">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-text">
                            Where the MIDI Player sends its output.
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between monospaced small">
                        <span id="HTMLo_midiPlayer_curTime${dhcID}">00:00</span>
                        <span id="HTMLo_midiPlayer_status${dhcID}" class="text-muted">No file loaded</span>
